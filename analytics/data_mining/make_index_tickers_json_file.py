...
# return or where to save output
outputPath = '' 
# outputPath = "data/index_tickers_dataframe_{0}.json".format(datetime.now().strftime('%Y-%m-%d_%H-%M-%S'))
...
if outputPath != '':
    ...
    index_ticker_dataframe.to_json(outputPath)
